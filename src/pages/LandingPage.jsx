    ...
    <div className="bg-white min-h-screen text-brand-green selection:bg-accent-gold selection:text-white font-sans relative overflow-x-hidden">
      ...
      <nav 
        className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-700 ${
          isScrolled 
            ? "py-4 bg-white/90 backdrop-blur-2xl border-b border-black/5" 
        ...
        <div className="max-w-7xl mx-auto px-8 flex justify-between items-center">
          <Link to="/" className="flex items-center group">
            <div className="relative">
              ...
              <img src={mainLogo} alt="Trade Balance" className="relative h-18 md:h-22 w-auto drop-shadow-2xl hover:scale-110 transition-all duration-500" />
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-7">
            {navLinks.map((link) => (
              link.href.startsWith("#") ? (
                <a 
                  key={link.name} 
                  href={link.href}
                  className={`${isScrolled ? "text-brand-green" : "text-white"} font-bold hover:text-accent-gold text-[10px] tracking-[0.4em] uppercase transition-all gold-underline`}
                >
                  {link.name}
                </a>
              ) : (
            ...
            <Link 
              to="/login" 
              className={`px-10 py-3 border ${isScrolled ? "border-brand-green/30 text-brand-green hover:bg-brand-green hover:text-white" : "border-white/30 text-white hover:bg-white hover:text-black"} transition-all duration-500 rounded-full text-[10px] font-bold tracking-[0.3em] uppercase shadow-sm`}
            >
              Login
            </Link>
          </div>
      ...
      <section id="hero" className="relative h-screen w-full flex items-center justify-center pt-24 md:pt-32 overflow-hidden bg-transparent z-10 select-none">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
          ...
          >
            ...
            <motion.h1 
              ...
              className="gold-green-shimmer text-[2.5rem] md:text-[4rem] lg:text-[6rem] font-serif font-black mb-8 tracking-[0.15em] uppercase leading-[1.1] "
            >
              THE POWER <br /> OF UNITY
            </motion.h1>
            
            {/* Subheadline (German Text) - Strictly 16px to 22px range */}
            <motion.p 
              variants={{
              ...
              className="text-white/80 font-medium text-sm md:text-lg lg:text-[22px] font-sans tracking-[0.1em] max-w-4xl mx-auto mb-16 leading-relaxed drop-shadow-md"
            >
            ...
            >
              ...
              <div className="mt-14 flex items-center justify-center gap-6 opacity-30">
      ...
      <section id="complan" className="py-32 bg-transparent border-y border-black/5 relative z-10">
...
const EarningCalculator = () => {
  ...
  return (
    <section id="calculator" className="py-32 bg-transparent relative z-10">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <p className="text-text-muted mb-10 font-light leading-relaxed max-w-xl">
              Our Unilevel protocol spans 10 levels deep. With a simple <span className="text-accent-gold font-bold">$2 yield</span> per active node and our integrated <span className="text-white font-bold">Pass-up System</span>, your scalability is architected for success.
            </p>
            
            <div className="space-y-6">
              {[
                { l: "10 Levels Deep Structure", v: "Gated Access" },
                { l: "Direct Yield Per Active Node", v: "$2.00 USD" },
            ...
            <div className="mb-12 relative z-10">
              ...
              <div className="relative pt-2">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-black/30 text-xs font-bold uppercase tracking-tighter">1 Node</span>
                  <span className="text-brand-green font-serif text-5xl md:text-6xl italic drop-shadow-sm">{partners} <span className="text-sm uppercase tracking-widest not-italic ml-2">Nodes</span></span>
...
const ExplainerContent = () => {
  ...
  const steps = [
    ...
    { text: "Direct 10-Level Unilevel Growth", sub: "$2 passive yield per active node across your empire." },
