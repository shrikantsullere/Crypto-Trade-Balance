...
import AppLayout from "./components/layout/user/AppLayout";
import PageTransition from "./components/ui/PageTransition";
import LandingPage from "./pages/LandingPage";
import LoginPage from "./pages/LoginPage";
import RegisterPage from "./pages/RegisterPage";
import TelegramOnboardingPage from "./pages/user/TelegramOnboardingPage";
import DashboardPage from "./pages/user/DashboardPage";
import MinimalDashboard from "./pages/user/MinimalDashboard";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const tryPlay = () => {
      if (audioRef.current && location.pathname === "/" && audioRef.current.paused) {
        audioRef.current.play()
          .then(() => console.log("Music Playing"))
          .catch(() => {
            // Silently catch autoplay block to avoid console spam
          });
      }
    };
    ...
    // Use only high-intent interactions for autoplay
    ...
    <>
      ...
      <AnimatePresence mode="wait">
        ...
        <Route element={<AppLayout />}>
          ...
          <Route path="/profile" element={withTransition(<UserProfilePage />)} />
        </Route>
        ...
        <Route element={<AdminLayout />}>
          ...
          <Route path="/admin/profile" element={withTransition(<AdminProfilePage />)} />
        </Route>
